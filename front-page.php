    ...
    <main class="main">
      ...
      <section>
        <div class="container">
          <div class="top_newsbox">
            <p class="text-center my-4 py-2 border-dark border-top border-bottom">現在、在宅勤務（リモートワーク）を実施しております。お問い合わせの際は、電話ではなく、本ホームページ上の「<a href="<?php echo esc_url( home_url( '/' ) ); ?>/inquiry">お問合せ</a>」欄よりご連絡ください。</p>
          </div>
        </div>
      </section>
      <!-- / ニュース / top -->
          ...
          <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="<?php echo get_template_directory_uri(); ?>/img/img20171031231807208238.jpg" class="d-inline-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/img20171031232139776829.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/img20171031232152197698.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/img20171106164831570048.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/img20171210221448523257.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-img-1.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-img-2.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-img-3.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-img-4.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-img-5.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-img-7.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-img-8.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-img-10.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-img-11.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-img-13.jpg" class="d-block w-100 img-fluid carousel-img" alt="...">
              </div>
      ...
      <section>
        <div class="container">
          <div class="row overview-wrap">
            <div class="col-lg-3">
              <img src="<?php echo get_template_directory_uri(); ?>/img/kawakami_img4.jpg" class="img-fluid  overview-img ">
            </div>
            <div class="overview col-lg-9">
              ...
              <p class=" c-body">
                ...
                <span class=" d-underline"><a class ="text-light" href="<?php echo esc_url( home_url( '/' ) ); ?>/overview" data-pid="258">
      ...
      <section class="album mt-5 pt-3 pb-5 bg-light">
        <div class="container">
            ...
            <div class="col-lg-3 col-md-6">
              <a href="<?php echo get_post_type_archive_link('kawakami_commentary'); ?>" >
                <div class="mb-4 shadow-sm director-card">
                  <div class="pt-2 px-4 ">
                    <h5>川上高司<img src="<?php echo get_template_directory_uri(); ?>/img/color_new.png" alt="LinkIcon" class="img-icon"></h5>
                  </div>
          ...
          <div> 
            <a href="<?php echo get_post_type_archive_link('director_commentary'); ?>" data-pid="257"><img src="<?php echo get_template_directory_uri(); ?>/img/flat_02_red.png" alt="LinkIcon" class="img-icon">過去の理事時事解説はこちら</a> 
          </div>      
        </div>
      </section>     
      <!-- 理事時事解説  -->
      ...
      <section class="album pt-3 pb-5 ">
        <div class="container">
          <h2 class="mt-8 fw-bold s-title">
            <a href="<?php echo get_post_type_archive_link('commentary'); ?>" class="text-decoration-none"><span class="fw-bold s-title"></span>コメンタリー</span></a> 
          </h2>
          <div class="row">
              ...
              <a href="<?php echo get_template_directory_uri(); ?>/commentary/FPC-commentary-volume19.pdf" target="_blank" rel="noopener noreferrer">
                <div class="commentary-card mb-4 shadow-sm">
                  <div class="pt-2 px-4 commentary-card-body">
                    <h5 class="text-center">FPC Commentary Vol.19</h5>
                    <h5 class="text-center">「中欧から見る欧州情勢（２）<br>：中国との関係」（細田尚志）<br>（発行：12月25日）</h5>
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              <a href="<?php echo get_template_directory_uri(); ?>/commentary/FPC-commentary-volume18.pdf" target="_blank" rel="noopener noreferrer">
                <div class="commentary-card mb-4 shadow-sm"> 
                  <div class="pt-2 px-4 commentary-card-body">
                    <h5 class="text-center">FPC Commentary Vol.18</h5>
                    <h5 class="text-center">「中国先祖がえり」（蟹瀬誠一）<br>（発行：11月26日）</h5>
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              <a href="<?php echo get_template_directory_uri(); ?>/commentary/FPC-commentary-volume17.pdf" target="_blank" rel="noopener noreferrer">
                <div class="commentary-card mb-4 shadow-sm">
                  <div class="pt-2 px-4 commentary-card-body">
                    <h5 class="text-center">FPC Commentary Vol.17</h5>
                    <h5 class="text-center">「中欧から見る欧州情勢(１)：ロシアとの関係」（細田尚志）<br>（発行：11月20日）</h5>
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              <a href="<?php echo get_template_directory_uri(); ?>/commentary/FPC-commentary-volume16.pdf" target="_blank" rel="noopener noreferrer">
                <div class="commentary-card mb-4 shadow-sm">
                  <div class="pt-2 px-4 commentary-card-body">
                    <h5 class="text-center">FPC Commentary Vol.16</h5>
                    <h5 class="text-center">「米カリフォルニア州知事リコール騒動とトランピズムの脅威」（蟹瀬誠一）<br>（発行：10月20日）</h5>
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              <a href="<?php echo get_template_directory_uri(); ?>/commentary/FPC-commentary-volume15.pdf" target="_blank" rel="noopener noreferrer">
                <div class="commentary-card mb-4 shadow-sm">
                  <div class="pt-2 px-4 commentary-card-body">
                    <h5 class="text-center">FPC Commentary Vol.15</h5>
                    <h5 class="text-center">「オリンピックと『多様な』『日本人』」<br>（石澤靖治）<br>（発行：9月27日）</h5>
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              <a href="commentary/FPC-commentary-volume14.pdf" target="_blank" rel="noopener noreferrer">
                <div class="commentary-card mb-4 shadow-sm">
                  <div class="pt-2 px-4 commentary-card-body">
                    <h5 class="text-center">FPC Commentary Vol.14</h5>
                    <h5 class="text-center">「トランプ暴露本」（蟹瀬誠一）<br>（発行：9月23日）</h5>
                  </div>
          ...
          <div> 
            <a href="<?php echo get_post_type_archive_link('commentary'); ?>" data-pid="257"><img src="<?php echo get_template_directory_uri(); ?>/img/flat_02_red.png" alt="LinkIcon" class="img-icon">過去のコメンタリーはこちら</a> 
          </div>      
        </div>
      </section>  
      ...
      <section class="album pt-3 pb-5 bg-light">
        <div class="container">
          <h2 class=" fw-bold s-title">
          <a href="<?php echo get_post_type_archive_link('fpc_news'); ?>" class="text-decoration-none">FPCニュース</a>
        </h2>
        <div class="row">
          <div class="col-lg-4 col-md-6">
              <a href="<?php echo get_template_directory_uri(); ?>/fpc_news/fpc-news-17.pdf" target="_blank" rel="noopener noreferrer">
                <div class="commentary-card mb-4 shadow-sm">
                  <div class="pt-2 px-4 commentary-card-body">
                    <h5 class="text-center">FPC NEWS vol.17</h5>
                    <h5 class="text-center">「宇宙の混雑化」問題を引き起こすデブリ</h5>
                  </div>
                  <img class="card-img-top d-block mx-auto img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/fpc_news/fpc-news-17.jpg" alt="Card image cap">
                </div>
              </a>
          </div>
          <div class="col-lg-4 col-md-6">
            <a href="<?php echo get_template_directory_uri(); ?>/fpc_news/fpc-news-16.pdf" target="_blank" rel="noopener noreferrer">
              <div class="commentary-card mb-4 shadow-sm">
                <div class="pt-2 px-4 commentary-card-body">
                  <h5 class="text-center">FPC NEWS vol.16</h5>
                  <h5 class="text-center">－FPC創設10周年記念セミナー－<br>「20年後の台湾と日本の反応」</h5>
                </div>
                <img class="card-img-top d-block mx-auto img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/fpc_news/fpc-news-16.jpg" alt="Card image cap">
              </div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6">
            <a href="<?php echo get_template_directory_uri(); ?>/fpc_news/fpc-news-15.pdf" target="_blank" rel="noopener noreferrer">
              <div class="commentary-card mb-4 shadow-sm"> 
                <div class="pt-2 px-4 commentary-card-body">
                  <h5 class="text-center">FPC NEWS vol.15</h5>
                  <h5 class="text-center">「インド太平洋の戦略的脆弱化に歯止めをかける：AUKUSと米国の艦艇建造計画」</h5>
                </div>
                <img class="card-img-top d-block mx-auto img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/fpc_news/fpc-news-15.jpg" alt="Card image cap">
              </div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6">
            <a href="<?php echo get_template_directory_uri(); ?>/fpc_news/fpc-news-14.pdf" target="_blank" rel="noopener noreferrer">
              <div class="commentary-card mb-4 shadow-sm">
                <div class="pt-2 px-4 commentary-card-body">
                  <h5 class="text-center">FPC NEWS vol.14</h5>
                  <h5 class="text-center">－コ ラ ム－<br>急速に進行する「宇宙の混雑化」問題</h5>
                </div>
                <img class="card-img-top d-block mx-auto img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/fpc_news/fpc-news-14.jpg" alt="Card image cap">
              </div>
            </a> 
          </div>
          <div class="col-lg-4 col-md-6">
            <a href="<?php echo get_template_directory_uri(); ?>/fpc_news/fpc-news-13.pdf" target="_blank" rel="noopener noreferrer">
              <div class="commentary-card mb-4 shadow-sm">
                <div class="pt-2 px-4 commentary-card-body">
                  <h5 class="text-center">FPC NEWS vol.13</h5>
                  <h5 class="text-center">－コ ラ ム－<br>「アフガニスタンの混乱：環状道路建設と経済・安全保障」</h5>
                </div>
                <img class="card-img-top d-block mx-auto img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/fpc_news/fpc-news-13.jpg" alt="Card image cap">
              </div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6">
            <a href="<?php echo get_template_directory_uri(); ?>/fpc_news/fpc-news-12.pdf" target="_blank" rel="noopener noreferrer">
              <div class="commentary-card mb-4 shadow-sm">
                <div class="pt-2 px-4 commentary-card-body">
                  <h5 class="text-center">FPC NEWS vol.12</h5>
                  <h5 class="text-center">新年のご挨拶</h5>
                </div>
                <img class="card-img-top d-block mx-auto img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/fpc_news/fpc-news-12.jpg" alt="Card image cap">
              </div>
            </a>
          </div>
          
          <div> 
            <a href="<?php echo get_post_type_archive_link('fpc_news'); ?>" data-pid="257"><img src="<?php echo get_template_directory_uri(); ?>/img/flat_02_red.png" alt="LinkIcon" class="img-icon">過去のFPCニュースはこちら</a> 
          </div>      
        </div>
      </section>
      <!-- / FPCニュース -->
      ...
      <secion>
        <div class="container">
          <h2 class="s-title mt-5">
            <a href="<?php echo get_post_type_archive_link('book_introduction'); ?>" class="text-decoration-none"><span class="fw-bold s-title">書籍紹介</span></a> 
          </h2>
          <div class="row">
                ...
                <div class="carousel-grid col-lg-3 col-md-4 col-sm-12">
                  <div class="card mb-4 shadow-sm">
                    <div class="pt-2 px-4 card-writings">
                      <h5>インテリジェンス用語事典　（2022/2/10）</h5>
                      <p class="pt-1 book-p">並木書房</p>
                      <p class="book-p">監修：川上高司</p>
                      <p class="book-p">執筆：樋口敬祐・上田篤盛・志田淳二郎</p>
                    </div>
                    <img class="card-img-top1 d-block mx-auto img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/book1.jpg" alt="Card image cap">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                          <a class="btn btn-sm btn-outline-secondary" href="https://www.amazon.co.jp/%E3%82%A4%E3%83%B3%E3%83%86%E3%83%AA%E3%82%B8%E3%82%A7%E3%83%B3%E3%82%B9%E7%94%A8%E8%AA%9E%E4%BA%8B%E5%85%B8-%E6%A8%8B%E5%8F%A3-%E6%95%AC%E7%A5%90/dp/4890634177/ref=sr_1_1?__mk_ja_JP=%E3%82%AB%E3%82%BF%E3%82%AB%E3%83%8A&crid=9TTTCC177DDX&keywords=%E3%82%A4%E3%83%B3%E3%83%86%E3%83%AA%E3%82%B8%E3%82%A7%E3%83%B3%E3%82%B9%E7%94%A8%E8%AA%9E%E4%BA%8B%E5%85%B8&qid=1643645205&s=books&sprefix=%2Cstripbooks%2C679&sr=1-1" target="_blank" rel="noopener noreferrer">
                            購入する
                          </a>
                        </div>
                      </div>
          ...
          <div> 
            <a href="<?php echo get_post_type_archive_link('book_introduction'); ?>" data-pid="257"><img src="<?php echo get_template_directory_uri(); ?>/img/flat_02_red.png" alt="LinkIcon" class="img-icon">過去の書籍情報はこちら</a> 
          </div>
        </div>
      ...
      <section  id="update">
        <div class="container">
          <h3 class="pt-5 mt-5 mb-4 fw-bold s-title update-information-h3" id="">
            <a href="<?php echo get_post_type_archive_link('update_information'); ?>" class="text-decoration-none">更新情報</a>
          </h3> 
          ...
          <div class=" c-body c-right pt-3 pb-5"> 
            <a href="<?php echo get_post_type_archive_link('update_information'); ?>" data-pid="257"><img src="<?php echo get_template_directory_uri(); ?>/img/flat_02_red.png" alt="LinkIcon" class="img-icon">過去の更新情報はこちら</a> 
          </div>
        </div>
      </section>
      <!-- / 更新情報 -->
